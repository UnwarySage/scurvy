(ns scurvy.name
  (:require [scurvy.random :as rnd]))

(def firstnames
  ["Abigayl", "Aebria", "Aeobreia", "Breia", "Aedria", "Aodreia", "Dreia", "Aeliya", "Aliya"
...
(def surnames
  ["Bright", "Brown", "Browne", "Brushfire", "Camp", "Campman", "Canyon", "Cricketts", "Crickets"
...
(defn generate-syllable-first-name []
  (str (rnd/choose-from firstnames)
       " "
       (rnd/choose-from surnames)))

(defn generate-name []
  (generate-syllable-first-name))
